...
import MyNotesShow from './MyNotesShow/MyNotesShow';
import MyNotesUpload from './MyNotesUpload/MyNotesUpload';
const MyNotes = () => {
    return (
        ...
        <Tabs className="w-full">
            ...
            <TabPanel className="space-y-6">
                <MyNotesShow></MyNotesShow>
            </TabPanel>
            <TabPanel className="space-y-6">
               <MyNotesUpload></MyNotesUpload>
            </TabPanel>
        </Tabs>
    </div>
    );
