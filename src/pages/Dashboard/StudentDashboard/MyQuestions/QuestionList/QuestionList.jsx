    ...
    return (
        <div className="max-w-6xl mx-auto p-6">
            ...
            {loading ? (
                ...
                <div className="grid md:grid-cols-4 sm:grid-cols-2 grid-cols-1 gap-3">
                    {files.map((file) => (
                        <div key={file._id} className="bg-white border border-gray-200 shadow-md rounded-lg overflow-hidden transform transition duration-300 hover:-translate-y-1 hover:shadow-lg">
                            ...
                            <div className="p-4">
                                <h3 className="text-lg font-semibold text-gray-900 truncate">{file.filename || "Untitled Question"}</h3>
                ...
                <p className="text-gray-500 text-center">No questions uploaded yet.</p>
            )}
        </div>
    );
};
